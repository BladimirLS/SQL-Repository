...
SET @SalesPersonEmailInput = 'CalKienl@ABCCorp.com';
...
DECLARE @SqlCmd AS nvarchar(1000);
DECLARE @SalesPersonEmailInput AS nvarchar(500);
SET @SalesPersonEmailInput = 'ShandiePoetz@ABCCorp.com';
...
SET @SalesPersonEmail = 'ShandiePoetz@ABCCorp.com';
...
DECLARE @SqlCmd AS nvarchar(1000);
DECLARE @SalesPersonEmail AS nvarchar(500);
SET @SalesPersonEmail = 'CalKienl@ABCCorp.com';
